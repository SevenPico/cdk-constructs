module github.com/sevenpico/examples/cdk-construct-sfn-error-notification-comprehensive
...
require (
	...
	github.com/sevenpico/cdk-constructs/cdkconstructsfnerrornotification v0.0.0
	// replace github.com/sevenpico/cdk-constructs/cdkconstructsfnerrornotification => <path-to-dist/go/.../cdkconstructsfnerrornotification@v0.0.0>
)
