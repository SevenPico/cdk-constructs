# cdk-construct-kinesis-stream — Disabled Example

Demonstrates `@sevenpico/cdk-construct-kinesis-stream` with `enabled: false` — shows the zero-resources pattern where no AWS resources are created.
