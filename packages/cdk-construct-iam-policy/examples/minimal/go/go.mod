module github.com/sevenpico/examples/cdk-construct-iam-policy-minimal
...
require (
	...
	github.com/sevenpico/cdk-constructs/cdkconstructiampolicy v0.0.0
	// replace github.com/sevenpico/cdk-constructs/cdkconstructiampolicy => <path-to-dist/go/.../cdkconstructiampolicy@v0.0.0>
)
