module github.com/sevenpico/examples/cdk-construct-slackbot-disabled
...
require (
	...
	github.com/sevenpico/cdk-constructs/cdkconstructslackbot v0.0.0
	// replace github.com/sevenpico/cdk-constructs/cdkconstructslackbot => <path-to-dist/go/.../cdkconstructslackbot@v0.0.0>
)
