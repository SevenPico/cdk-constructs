...
app = cdk.App()
stack = cdk.Stack(app, "CloudtrailCloudwatchAlarmsComprehensiveStack")
...
CloudtrailCloudwatchAlarms(stack, "Alarms",
    ...
    alarm_namespace="AcmeSecurity",
    alarm_period_seconds=60,
    alarm_evaluation_periods=1,
    alarm_threshold=1,
    enabled_alarms=["unauthorized-api", "root-usage", "iam-policy-changes", "cloudtrail-changes"],
)
