module github.com/sevenpico/examples/cdk-construct-cloudtrail-cloudwatch-alarms-comprehensive
...
require (
	...
	github.com/sevenpico/cdk-constructs/cdkconstructcloudtrailcloudwatchalarms v0.0.0
	// replace github.com/sevenpico/cdk-constructs/cdkconstructcloudtrailcloudwatchalarms => <path-to-dist/go/.../cdkconstructcloudtrailcloudwatchalarms@v0.0.0>
)
