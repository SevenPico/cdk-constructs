module github.com/sevenpico/examples/cdk-construct-secret-with-sns
...
require (
	...
	github.com/sevenpico/cdk-constructs/cdkconstructsecret v0.0.0
	// replace github.com/sevenpico/cdk-constructs/cdkconstructsecret => <path-to-dist/go/.../cdkconstructsecret@v0.0.0>
)
