# cdk-construct-cloudtrail — Disabled Example

Demonstrates `@sevenpico/cdk-construct-cloudtrail` with `enabled: false` — shows the zero-resources pattern where no AWS resources are created.
