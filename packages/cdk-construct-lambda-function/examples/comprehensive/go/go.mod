module github.com/sevenpico/examples/cdk-construct-lambda-function-comprehensive
...
require (
	...
	github.com/sevenpico/cdk-constructs/cdkconstructlambdafunction v0.0.0
	// replace github.com/sevenpico/cdk-constructs/cdkconstructlambdafunction => <path-to-dist/go/.../cdkconstructlambdafunction@v0.0.0>
)
