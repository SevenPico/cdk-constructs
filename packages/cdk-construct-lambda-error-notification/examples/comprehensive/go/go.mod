module github.com/sevenpico/examples/cdk-construct-lambda-error-notification-comprehensive
...
require (
	...
	github.com/sevenpico/cdk-constructs/cdkconstructlambdaerrornotification v0.0.0
	// replace github.com/sevenpico/cdk-constructs/cdkconstructlambdaerrornotification => <path-to-dist/go/.../cdkconstructlambdaerrornotification@v0.0.0>
)
