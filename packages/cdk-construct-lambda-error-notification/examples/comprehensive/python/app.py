...
from sevenpico.cdk_construct_lambda_error_notification import (
    LambdaErrorNotification,
    SqsKmsConfig,
)

app = cdk.App()
stack = cdk.Stack(app, "LambdaErrorNotificationComprehensiveStack")
...
LambdaErrorNotification(stack, "LambdaMonitor",
    ...
    target_lambda_input_template="<$.requestPayload>",
)
