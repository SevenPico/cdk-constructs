module github.com/sevenpico/examples/cdk-construct-s3-website-comprehensive
...
require (
	...
	github.com/sevenpico/cdk-constructs/cdkconstructs3website v0.0.0
	// replace github.com/sevenpico/cdk-constructs/cdkconstructs3website => <path-to-dist/go/.../cdkconstructs3website@v0.0.0>
)
