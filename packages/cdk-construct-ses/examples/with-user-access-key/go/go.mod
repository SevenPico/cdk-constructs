module github.com/sevenpico/examples/cdk-construct-ses-with-user-access-key
...
require (
	...
	github.com/sevenpico/cdk-constructs/cdkconstructses v0.0.0
	// replace github.com/sevenpico/cdk-constructs/cdkconstructses => <path-to-dist/go/.../cdkconstructses@v0.0.0>
)
