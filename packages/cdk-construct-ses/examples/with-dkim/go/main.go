...
func main() {
	...
	stack := awscdk.NewStack(app, jsii.String("SesWithDkimStack"), nil)
	...
	ses.NewSes(stack, jsii.String("Ses"), &ses.SesProps{
		Context:      context,
		VerifyDomain: jsii.Bool(true),
		VerifyDkim:   jsii.Bool(true),
		ZoneId:       jsii.String("Z0PUBLICZONEID00000"),
		ZoneName:     jsii.String("dev.acme.example.com"),
	})
