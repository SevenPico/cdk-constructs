module github.com/sevenpico/examples/cdk-construct-iam-role-minimal
...
require (
	...
	github.com/sevenpico/cdk-constructs/cdkconstructiamrole v0.0.0
	// replace github.com/sevenpico/cdk-constructs/cdkconstructiamrole => <path-to-dist/go/.../cdkconstructiamrole@v0.0.0>
)
