module github.com/sevenpico/examples/cdk-construct-http-api-gateway-comprehensive
...
require (
	...
	github.com/sevenpico/cdk-constructs/cdkconstructhttpapigateway v0.0.0
	// replace github.com/sevenpico/cdk-constructs/cdkconstructhttpapigateway => <path-to-dist/go/.../cdkconstructhttpapigateway@v0.0.0>
)
