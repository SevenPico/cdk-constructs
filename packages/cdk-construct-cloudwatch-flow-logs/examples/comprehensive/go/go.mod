module github.com/sevenpico/examples/cdk-construct-cloudwatch-flow-logs-comprehensive
...
require (
	...
	github.com/sevenpico/cdk-constructs/cdkconstructcloudwatchflowlogs v0.0.0
	// replace github.com/sevenpico/cdk-constructs/cdkconstructcloudwatchflowlogs => <path-to-dist/go/.../cdkconstructcloudwatchflowlogs@v0.0.0>
)
