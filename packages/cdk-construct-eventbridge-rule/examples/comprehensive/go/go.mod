module github.com/sevenpico/examples/cdk-construct-eventbridge-rule-comprehensive
...
require (
	...
	github.com/sevenpico/cdk-constructs/cdkconstructeventbridgerule v0.0.0
	// replace github.com/sevenpico/cdk-constructs/cdkconstructeventbridgerule => <path-to-dist/go/.../cdkconstructeventbridgerule@v0.0.0>
)
