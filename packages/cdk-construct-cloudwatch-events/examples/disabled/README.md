# cdk-construct-cloudwatch-events — Disabled Example

Demonstrates `@sevenpico/cdk-construct-cloudwatch-events` with `enabled: false` — shows the zero-resources pattern where no AWS resources are created.
