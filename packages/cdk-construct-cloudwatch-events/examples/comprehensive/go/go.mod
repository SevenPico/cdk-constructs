module github.com/sevenpico/examples/cdk-construct-cloudwatch-events-comprehensive
...
require (
	...
	github.com/sevenpico/cdk-constructs/cdkconstructcloudwatchevents v0.0.0
	// replace github.com/sevenpico/cdk-constructs/cdkconstructcloudwatchevents => <path-to-dist/go/.../cdkconstructcloudwatchevents@v0.0.0>
)
