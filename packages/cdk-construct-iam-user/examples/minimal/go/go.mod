module github.com/sevenpico/examples/cdk-construct-iam-user-minimal
...
require (
	...
	github.com/sevenpico/cdk-constructs/cdkconstructiamuser v0.0.0
	// replace github.com/sevenpico/cdk-constructs/cdkconstructiamuser => <path-to-dist/go/.../cdkconstructiamuser@v0.0.0>
)
