# cdk-construct-sns — Disabled Example

Demonstrates `@sevenpico/cdk-construct-sns` with `enabled: false` — shows the zero-resources pattern where no AWS resources are created.
