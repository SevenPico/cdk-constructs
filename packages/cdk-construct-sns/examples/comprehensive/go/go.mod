module github.com/sevenpico/examples/cdk-construct-sns-comprehensive
...
require (
	...
	github.com/sevenpico/cdk-constructs/cdkconstructsns v0.0.0
	// replace github.com/sevenpico/cdk-constructs/cdkconstructsns => <path-to-dist/go/.../cdkconstructsns@v0.0.0>
)
