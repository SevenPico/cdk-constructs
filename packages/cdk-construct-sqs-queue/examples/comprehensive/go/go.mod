module github.com/sevenpico/examples/cdk-construct-sqs-queue-comprehensive
...
require (
	...
	github.com/sevenpico/cdk-constructs/cdkconstructsqsqueue v0.0.0
	// replace github.com/sevenpico/cdk-constructs/cdkconstructsqsqueue => <path-to-dist/go/.../cdkconstructsqsqueue@v0.0.0>
)
