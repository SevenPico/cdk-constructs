# cdk-construct-step-functions — Disabled Example

Demonstrates `@sevenpico/cdk-construct-step-functions` with `enabled: false` — shows the zero-resources pattern where no AWS resources are created.
