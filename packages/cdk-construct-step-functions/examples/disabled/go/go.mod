module github.com/sevenpico/examples/cdk-construct-step-functions-disabled
...
require (
	...
	github.com/sevenpico/cdk-constructs/cdkconstructstepfunctions v0.0.0
	// replace github.com/sevenpico/cdk-constructs/cdkconstructstepfunctions => <path-to-dist/go/.../cdkconstructstepfunctions@v0.0.0>
)
