module github.com/sevenpico/examples/cdk-construct-eventbridge-comprehensive
...
require (
	...
	github.com/sevenpico/cdk-constructs/cdkconstructeventbridge v0.0.0
	// replace github.com/sevenpico/cdk-constructs/cdkconstructeventbridge => <path-to-dist/go/.../cdkconstructeventbridge@v0.0.0>
)
