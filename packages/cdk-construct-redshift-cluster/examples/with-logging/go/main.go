...
func main() {
	...
	stack := awscdk.NewStack(app, jsii.String("RedshiftClusterWithLoggingStack"), nil)
	...
	redshiftcluster.NewRedshiftCluster(stack, jsii.String("Cluster"), &redshiftcluster.RedshiftClusterProps{
		...
		LoggingEnabled:     jsii.Bool(true),
		LoggingBucketName:  jsii.String("acme-dev-app-logs-123456789012"),
	})
