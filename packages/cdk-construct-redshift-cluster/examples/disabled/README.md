# RedshiftCluster — disabled example

Demonstrates `@sevenpico/cdk-construct-redshift-cluster` with the construct disabled via `enabled: false` in context. No AWS resources are created when the construct is disabled.
