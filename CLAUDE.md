...
## Agent Cost Rules
Sonnet only for spawns. Pass `"model": "sonnet"` explicitly. Opus = 15x cost.
Agents in `.nanoclip/agents/`. Pipeline: resource-specialist → code-reviewer → qa-engineer → lead-engineer.
