...
const cdkContext = pkg('cdk-context', 'cdk-context', { cdkVersion: '2.246.0', deps: [] });
...
pkg('cdk-construct-s3-log-storage',                  'cdk-construct-s3-log-storage',                  { peerDeps: [...ctx, '@sevenpico/cdk-construct-s3-bucket'] });
...
pkg('cdk-construct-lambda-function',                 'cdk-construct-lambda-function',                 { peerDeps: ctx });
pkg('cdk-construct-lambda-error-notification',       'cdk-construct-lambda-error-notification',       { peerDeps: ctx, deps: ['@sevenpico/cdk-construct-sqs-queue'] });
pkg('cdk-construct-step-functions',                  'cdk-construct-step-functions',                  { peerDeps: ctx, deps: ['@sevenpico/cdk-construct-iam-role'] });
pkg('cdk-construct-sfn-error-notification',          'cdk-construct-sfn-error-notification',          { peerDeps: ctx, deps: ['@sevenpico/cdk-construct-sqs-queue'] });
pkg('cdk-construct-express-sfn-error-notification',  'cdk-construct-express-sfn-error-notification',  { peerDeps: ctx, deps: ['@sevenpico/cdk-construct-sqs-queue'] });
pkg('cdk-construct-sqs-queue',                       'cdk-construct-sqs-queue',                       { peerDeps: ctx });
pkg('cdk-construct-sns',                             'cdk-construct-sns',                             { peerDeps: ctx });
pkg('cdk-construct-kinesis-stream',                  'cdk-construct-kinesis-stream',                  { peerDeps: ctx });
pkg('cdk-construct-eventbridge',                     'cdk-construct-eventbridge',                     { peerDeps: ctx });
pkg('cdk-construct-eventbridge-rule',                'cdk-construct-eventbridge-rule',                { peerDeps: ctx });
pkg('cdk-construct-dynamodb',                        'cdk-construct-dynamodb',                        { peerDeps: ctx });
pkg('cdk-construct-redshift-cluster',                'cdk-construct-redshift-cluster',                { peerDeps: ctx });
pkg('cdk-construct-ses',                             'cdk-construct-ses',                             { peerDeps: ctx });
pkg('cdk-construct-http-api-gateway',                'cdk-construct-http-api-gateway',                { peerDeps: ctx });
pkg('cdk-construct-slackbot',                        'cdk-construct-slackbot',                        { peerDeps: ctx, deps: ['@sevenpico/cdk-construct-sns', '@sevenpico/cdk-construct-lambda-function'] });
pkg('cdk-construct-cloudtrail',                      'cdk-construct-cloudtrail',                      { peerDeps: ctx });
pkg('cdk-construct-cloudtrail-cloudwatch-alarms',    'cdk-construct-cloudtrail-cloudwatch-alarms',    { peerDeps: ctx });
pkg('cdk-construct-cloudwatch-events',               'cdk-construct-cloudwatch-events',               { peerDeps: ctx });
pkg('cdk-construct-cloudwatch-flow-logs',            'cdk-construct-cloudwatch-flow-logs',            { peerDeps: ctx });
